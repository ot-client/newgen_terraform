...
#     private_endpoint_id   = azurerm_private_endpoint.redis_pe[0].id
#     private_endpoint_name = azurerm_private_endpoint.redis_pe[0].name
#     private_ip_address    = azurerm_private_endpoint.redis_pe[0].private_service_connection[0].private_ip_address
#     subnet_id             = azurerm_private_endpoint.redis_pe[0].subnet_id
#   } : null
# }
